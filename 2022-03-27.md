...
1. 인증서 추출
keytool -exportcert -keystore jssecacerts -storepass changeit -file output.cert -alias siljuk.koras.org-1
2. 추출한 인증서 import
keytool -importcert -keystore E:\Site\java\jdk8\jre\lib\security\cacerts -storepass changeit -file output.cert -alias siljuk.koras.org-1
3. 추출한 인증서 확인.
